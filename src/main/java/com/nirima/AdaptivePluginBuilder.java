...
public class AdaptivePluginBuilder extends Builder {
...
//            listener.getLogger().println("Hello, "+name+"!");
    ...
    /**
     * Descriptor for {@link AdaptivePluginBuilder}. Used as a singleton.
     * The class is marked as public so that it can be accessed from views.
     *
     * <p>
     * See <tt>views/hudson/plugins/hello_world/AdaptivePluginBuilder/*.jelly</tt>
